...
export default function ProblemManagement() {
  ...
  return (
    <div className="space-y-6 p-4 max-w-7xl mx-auto">
      ...
      {/* Real-time Status */}
      <div className="flex items-center justify-between text-xs text-gray-400 bg-slate-800/30 rounded-lg p-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="relative sm:col-span-2">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-slate-700/50 border border-slate-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-purple-500 text-sm"
            />
          </div>
          ...
          <select
            ...
            className="px-3 py-2 bg-slate-700/50 border border-slate-600 rounded-lg text-white focus:outline-none focus:border-purple-500 text-sm"
          >
      ...
      {viewMode === "table" ? (
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl border border-slate-700/50 overflow-hidden">
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-slate-700/50">
                  {filteredProblems.map((problem) => (
                    <tr key={problem._id || problem.id} className="hover:bg-slate-700/30 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center space-x-2">
                          ...
                          <button className="p-2 text-purple-400 hover:text-purple-300 hover:bg-purple-400/10 rounded-lg transition-all">
          ...
          <div className="lg:hidden">
            <div className="divide-y divide-slate-700/50">
              {filteredProblems.map((problem) => (
                <div key={problem._id || problem.id} className="p-4 hover:bg-slate-700/30 transition-colors">
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <div className="flex items-center space-x-1 ml-2">
                      ...
                      <button className="p-1.5 text-purple-400 hover:text-purple-300 hover:bg-purple-400/10 rounded">
                        <PencilIcon className="w-4 h-4" />
                      </button>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {filteredProblems.map((problem) => (
            <div key={problem._id || problem.id} className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-4 border border-slate-700/50 hover:border-purple-500/30 transition-all">
              <div className="flex items-start justify-between mb-3">
                ...
                <div className="flex items-center space-x-1 ml-2">
                  ...
                  <button className="p-1 text-purple-400 hover:text-purple-300 hover:bg-purple-400/10 rounded">
