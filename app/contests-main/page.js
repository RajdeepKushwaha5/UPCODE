    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50 dark:from-gray-900 dark:via-blue-900/20 dark:to-purple-900/20">
      <div className="container mx-auto px-4 py-8">
        ...
        >
          ...
          <div className="mt-4 flex items-center justify-center gap-4 text-sm" style={{ color: 'var(--text-secondary)' }}>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-4 gap-8">
          ...
          <div className="xl:col-span-3 space-y-6">
            ...
            <motion.div
              ...
              className="rounded-xl p-6 shadow-lg" style={{ backgroundColor: 'var(--surface-base)' }}
            >
              <div className="flex flex-col md:flex-row gap-4 justify-between items-center">
                  ...
                  <div className="flex gap-2">
                    {['all', 'live', 'upcoming', 'completed'].map((filter) => (
                      <button
                        ...
                        style={selectedFilter !== filter ? { backgroundColor: 'var(--surface-raised)', color: 'var(--text-secondary)' } : {}}
                      >
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="pl-10 pr-4 py-2 rounded-lg border focus:ring-2 focus:ring-blue-500 focus:border-transparent" style={{ borderColor: 'var(--border-primary)', backgroundColor: 'var(--surface-base)', color: 'var(--text-primary)' }}
                  />
                </div>
              </div>
            </motion.div>
              ...
              <AnimatePresence>
                {filteredContests.map((contest, index) => (
                  <motion.div
                    ...
                    className="rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border-l-4 border-purple-500" style={{ backgroundColor: 'var(--surface-base)' }}
                  >
                    <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
                      <div className="flex-1">
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                          <div className="rounded-lg p-3" style={{ backgroundColor: 'var(--surface-raised)' }}>
                            <div className="text-sm mb-1" style={{ color: 'var(--text-secondary)' }}>Start Time</div>
                          ...
                          <div className="rounded-lg p-3" style={{ backgroundColor: 'var(--surface-raised)' }}>
                            <div className="text-sm mb-1" style={{ color: 'var(--text-secondary)' }}>Duration</div>
                            <div className="font-semibold" style={{ color: 'var(--text-primary)' }}>
                          ...
                          <div className="rounded-lg p-3" style={{ backgroundColor: 'var(--surface-raised)' }}>
                            <div className="text-sm mb-1" style={{ color: 'var(--text-secondary)' }}>Participants</div>
                            <div className="font-semibold" style={{ color: 'var(--text-primary)' }}>
                          ...
                          <div className="rounded-lg p-3" style={{ backgroundColor: 'var(--surface-raised)' }}>
                            <div className="text-sm mb-1" style={{ color: 'var(--text-secondary)' }}>Prize Pool</div>
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        <Link
                          ...
                          className="px-6 py-2 rounded-lg text-center transition-all duration-300" style={{ backgroundColor: 'var(--surface-raised)', color: 'var(--text-secondary)' }}
                        >
                          View Details
                        </Link>
                      </div>
          ...
          <div className="space-y-6">
            ...
            >
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-lg font-bold" style={{ color: 'var(--text-primary)' }}>Live Updates</h3>
              </div>
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-lg font-bold" style={{ color: 'var(--text-primary)' }}>Contest Calendar</h3>
                </div>
                <div className="flex items-center gap-2">
                  <button
                  ...
                  <div className="font-semibold px-3" style={{ color: 'var(--text-primary)' }}>
            ...
            >
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-lg font-bold" style={{ color: 'var(--text-primary)' }}>Quick Stats</h3>
              </div>
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span style={{ color: 'var(--text-secondary)' }}>Live Contests</span>
                ...
                <div className="flex justify-between items-center">
                  <span style={{ color: 'var(--text-secondary)' }}>Total Prize Pool</span>
        ...
        <motion.div
          ...
          className="mt-8 rounded-xl p-6 shadow-lg" style={{ backgroundColor: 'var(--surface-base)' }}
        >
