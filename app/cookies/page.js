      ...
      <div className="relative z-10">
        ...
        >
          <div className="text-center mb-12">
            ...
            >
              <FaCookieBite className="text-purple-400 text-2xl animate-pulse" />
              <span className="text-purple-300 font-semibold text-lg">Cookie Management</span>
            </motion.div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-r from-purple-600/20 to-pink-600/20 backdrop-blur-xl rounded-2xl p-8 border border-purple-400/30">
              <div className="text-center mb-8">
                <FaCog className="text-4xl text-purple-400 mx-auto mb-4" />
              ...
              <div className="grid md:grid-cols-2 gap-4 mb-6">
                {cookieTypes.map((cookie, index) => (
                  <motion.div
                    ...
                    className="bg-slate-800/80 rounded-xl p-6 border border-slate-600/30"
                  >
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-3">
                        <div className="text-purple-400 text-xl">{cookie.icon}</div>
            ...
            {cookieTypes.map((cookie, index) => (
              ...
              >
                ...
                <div className="bg-slate-700/50 rounded-xl p-6">
                  <h4 className="text-purple-300 font-semibold mb-4">Examples:</h4>
            ...
            <div className="space-y-6">
              {thirdPartyCookies.map((service, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="bg-slate-800/80 backdrop-blur-sm rounded-xl p-6 border border-slate-600/30"
                >
        ...
        >
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-r from-purple-600/20 to-pink-600/20 backdrop-blur-xl rounded-2xl p-8 border border-purple-400/30">
              <div className="text-center">
                <FaCookieBite className="text-4xl text-purple-400 mx-auto mb-4" />
