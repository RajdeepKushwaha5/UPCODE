        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 mb-8">
          {algorithms.map((algorithm, index) => (
            <Link 
              key={index}
              href={algorithm.path}
              className="group theme-surface/30 backdrop-blur-sm rounded-xl p-6 border border-slate-700/50 hover:border-orange-500/50 transition-all duration-300 hover:scale-105"
            >
